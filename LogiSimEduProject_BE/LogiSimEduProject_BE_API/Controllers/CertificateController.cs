...
[ApiController]
[Route("api/files")]
public class CloudinaryDownloadController : ControllerBase
{
    private readonly CloudinarySettings _opt;
    private readonly HttpClient _http;

    public CloudinaryDownloadController(IOptions<CloudinarySettings> opt, IHttpClientFactory httpFactory)
    {
        _opt = opt.Value;
